...
class Musixmatch:
  ...
  def __init__(self, token="230529b64b66f5149f49ecafe0340d6b43a0ec9b91f46df65bedb5"):
  ...
  def get_synced(song, body):
    ...
    # convert_lines to {text, startTime (ms)}
    if lines:
      for line in lines:
        line["startTime"] = (line["minutes"] * 60000) + (line["seconds"] * 1000) + (line["hundredths"] * 10)
